...
class OrderProductsControllerTest < ActionController::TestCase
  ...
  test "should create order_product" do
    assert_difference('OrderProduct.count') do
      post :create, order_product: { order_id: @order_product.order_id, product_id: @order_product.product_id, quantity: @order_product.quantity }
    end
  ...
  test "should update order_product" do
    patch :update, id: @order_product, order_product: { order_id: @order_product.order_id, product_id: @order_product.product_id, quantity: @order_product.quantity }
    assert_redirected_to order_product_path(assigns(:order_product))
  end
